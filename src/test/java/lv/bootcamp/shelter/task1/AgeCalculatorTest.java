...
class AgeCalculatorTest {
    ...
    void shouldThrowForNegativeYears() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> calculator.toMonths(-1));
    ...
    void shouldThrowForNegativeDogAge() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> calculator.dogToHumanYears(-1));
        assertTrue(e.getMessage().contains("negative"));
    }
    ...
    void shouldReturnTrueForAgeZero() {
